...
<table width="770" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td align="center" valign="top" bgcolor="#FFFFFF"><table width="755" height="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td height="32" align="center" valign="middle" background="images/greenbar.gif"><table width="750" border="0" cellspacing="0" cellpadding="0">
              <tr align="center" valign="middle">
                <td width="70" height="25"><a href="login" class="footermenu">Sign In</a></td>
                <td width="60" height="25"><a href="registration" class="footermenu">Sign Up</a></td>               
                <td width="80" height="25"><a href="admin" class="footermenu">Admin</a></td>    
